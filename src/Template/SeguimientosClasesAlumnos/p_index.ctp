    ...
    <div id="no-more-tables">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('Cargar'), ['action' => 'edit', $seguimientosClasesAlumno->id], ['class' => 'btn-sm btn-success','target' => '_blank']) ?>
                    <?= $this->Html->link(__('View'), ['action' => 'view', $seguimientosClasesAlumno->id], ['class' => 'btn-sm btn-info','target' => '_blank']) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
