...
<div class="col-lg-2"><div style="margin: 5px 0px 5px 5px;"><?php  echo $this->Html->link('Nuevo pago', ['controller' => 'PagosAlumnos', 'action' => 'pagoManual', $alumno->id],['class' => 'btn btn-success', 'margin-top' => '10px']); ?></div>
</div>
