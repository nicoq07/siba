...
<div style="margin: 5px 0px 5px 5px;"><?php  echo $this->Html->link('Ficha externa', ['action' => 'fichaExterna', $alumno->id ,'_ext' => 'pdf'],['class' => 'btn btn-info', 'margin-top' => '10px']); ?></div>
<div style="margin: 5px 0px 5px 5px;"><?php  echo $this->Html->link('Ficha interna', ['action' => 'fichaInterna', $alumno->id ,'_ext' => 'pdf'],['class' => 'btn btn-info', 'margin-top' => '10px']); ?></div>
