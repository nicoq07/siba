...
<div class="col-lg-8 col-lg-offset-2 panel panel-info">
	...
	<div id="PD"  style='display: none;'class='col-lg-12 panel-body'>
		...
		<div class="col-lg-12 ">
			<div class="col-lg-6 col-lg-offset-3"><button class='btn btn-sm btn-primary btn-block'  onclick='mostrarOcultar("masDatos",this);'><?php echo h('Desplegar Listado'); ?></button> </div>
