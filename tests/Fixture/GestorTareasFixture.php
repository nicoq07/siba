 ...
 *
 */
class GestorTareasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'FK_PrioridadGestorTareas' => ['type' => 'foreign', 'columns' => ['prioridad_id'], 'references' => ['gestor_tareas_prioridad', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
