...
class SeguimientosClasesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'clase_alumno_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'FK_ClaseAlumnoSeguimiento' => ['type' => 'foreign', 'columns' => ['clase_alumno_id'], 'references' => ['clases_alumnos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
